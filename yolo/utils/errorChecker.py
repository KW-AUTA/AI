...
class ErrorChecker:
	...
	def _coordinate_x_error(self, figma_box: List[int], web_box: List[int]) -> bool:
	...
	def _coordinate_y_error(self, figma_box: List[int], web_box: List[int]) -> bool:
	...
	def check_error(self, figma_box: List[int], web_box: List[int], figma_text: str, web_text: str) -> List[str]:
		errors = []
		if not self._coordinate_x_error(figma_box, web_box):
			errors.append(G_ERROR_COORDINATE_X)
		if not self._coordinate_y_error(figma_box, web_box):
